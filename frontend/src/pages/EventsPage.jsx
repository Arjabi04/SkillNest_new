...
import { Calendar, Plus, Search, Filter, Zap, X } from "lucide-react";
...
const EventsPage = () => {
    ...
    const joinedEvents = events.filter(
        (event) =>
            !isCurrentUserOrganizer(event) && hasCurrentUserJoined(event),
    );
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="pt-4 border-t border-slate-200 flex flex-wrap items-center gap-3">
                                {selectedIsOrganizer ? (
                                    ...
                                    <button
                                        onClick={() =>
                                            handleUnjoinEvent(selectedEvent._id)
                                        }
